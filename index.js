...
(function(w) {
    ...
    var screenSize = (window.innerWidth > 0) ? window.innerWidth : screen.width;
    var screenHeight = screen.height; 
    var resolution = 10; //Width and height of each cell in the grid.

    var canvas_width = screenSize - (screenSize%resolution); //Needs to be a multiple of the resolution value below.
    var canvas_height = screenHeight - (screenHeight%resolution); //This too.
